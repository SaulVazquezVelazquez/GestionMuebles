			...
			<div class="data-scrollbar" data-scroll="1">
				<nav class="iq-sidebar-menu">
					<ul id="iq-sidebar-toggle" class="iq-menu">
						...
						<li class="active">
							<a href="../backend/index.html">
								<i class="las la-file-invoice-dollar"></i><span>Cotizador</span>
							</a>
						</li>
						<li>
							<a href="../backend/index.html">
								<i class="las la-hands-helping"></i><span>Simulador</span>
							</a>
						</li>
						<li class=" ">
							<a href="#cotizaciones" class="collapsed" data-toggle="collapse" aria-expanded="false">
								<i class="las la-file-invoice"></i><span>Cotizaciones</span>
								<i class="las la-angle-right iq-arrow-right arrow-active"></i>
								<i class="las la-angle-down iq-arrow-right arrow-hover"></i>
							</a>
							<ul id="cotizaciones" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
								<li class=" ">
									<a href="../backend/widget-simple.html">
										<i class="las la-check-square"></i><span>Revisadas</span>
									</a>
								</li>
							</ul>
						</li>
						<li class=" ">
							...
							<ul id="validaciones" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
								<li class=" ">
									<a href="../backend/widget-simple.html">
										<i class="las la-check-double"></i><span>Validador</span>
									</a>
								</li>
								<li class=" ">
									<a href="../backend/widget-simple.html">
						...
						<li class=" ">
							<a href="#configuracion" class="collapsed" data-toggle="collapse" aria-expanded="false">
								<i class="las la-cogs"></i><span>Configuracion</span>
								<i class="las la-angle-right iq-arrow-right arrow-active"></i>
								<i class="las la-angle-down iq-arrow-right arrow-hover"></i>
							</a>
							<ul id="configuracion" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
								<li class=" ">
									<a href="../backend/widget-simple.html">
										<i class="las la-receipt"></i><span>Claves - Cantidades</span>
									</a>
								</li>
								<li class=" ">
									<a href="#apis" class="collapsed" data-toggle="collapse" aria-expanded="false">
										<i class="las la-server"></i><span>Apis</span>
										<i class="las la-angle-right iq-arrow-right arrow-active"></i>
										<i class="las la-angle-down iq-arrow-right arrow-hover"></i>
									</a>
									<ul id="apis" class="iq-submenu collapse" data-parent="#configuracion">
										<li class=" ">
											<a href="<?= base_url();?>sincronizar-apis">
												<i class="lab la-gg-circle"></i><span>Sincronizar</span>
											</a>
										</li>
									</ul>
								</li>
								<li class=" ">
									<a href="#catalogos" class="collapsed" data-toggle="collapse" aria-expanded="false">
										<i class="las la-database"></i><span>Catalogos</span>
										<i class="las la-angle-right iq-arrow-right arrow-active"></i>
										<i class="las la-angle-down iq-arrow-right arrow-hover"></i>
									</a>
									<ul id="catalogos" class="iq-submenu collapse" data-parent="#configuracion">
										<li class=" ">
											<a href="../backend/form-layout.html">
												<i class="las la-book"></i><span>Metodos -API</span>
											</a>
										</li>
										<li class=" ">
											<a href="../backend/form-input-group.html">
												<i class="las la-keyboard"></i><span>Roles</span>
											</a>
										</li>
										<li class=" ">
											<a href="../backend/form-validation.html">
												<i class="las la-edit"></i><span>Departamentos</span>
											</a>
										</li>
										<li class=" ">
											<a href="../backend/form-switch.html">
												<i class="las la-toggle-off"></i><span>Tipo Reporte</span>
											</a>
										</li>
										<li class=" ">
											<a href="../backend/form-chechbox.html">
												<i class="las la-check-square"></i><span>Planta</span>
											</a>
										</li>
										<li class=" ">
											<a href="../backend/form-radio.html">
												<i class="las la-yin-yang"></i><span>Almacen</span>
											</a>
										</li>
									</ul>
								</li>
													...
													<div class="profile-header">
														...
														<div class="personal-details">
															...
															<div class="row align-items-center mb-2">
																...
																<div class="col-sm-12">
																	<p class="mb-0">
																		<?= $this->session->userdata('s_departamento'); ?>
																	</p>
																</div>
															</div>
															<div class="row align-items-center mb-2">
																...
																<div class="col-sm-12">
																	<p class="mb-0">
																		<?= $this->session->userdata('s_planta'); ?></p>
																</div>
															</div>
														</div>
													</div>
