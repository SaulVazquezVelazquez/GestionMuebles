...
<?php if($this->uri->segment(1)=='reporte-inventario'){ ?>
        <script src="<?= base_url() ?>assets/js/violanti/combos/combos.js"></script>
		<script src="<?= base_url() ?>assets/js/violanti/reportes/inventario.js"></script>
<?php }else if($this->uri->segment(1)=='generar-reporte-inventario'){?>
	<script src="<?= base_url() ?>assets/js/violanti/export/reporte-inventario.js"></script>
<?php }else if($this->uri->segment(1)=='cotizaciones-pendientes-detalle'){?>
	<script src="<?= base_url() ?>assets/js/violanti/cotizacion/cotizacion-pendientes-detalle.js"></script>
