				...
				<nav class="iq-sidebar-menu">
					<ul id="iq-sidebar-toggle" class="iq-menu">
						...
						<li class=" ">
									...
									<i class="las la-exclamation"></i><span>Cotizaciones</span>
									</a>
						</li>
						<!-- <li class=" ">
							...
							<ul id="cotizaciones" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
								<li class=" ">
									<a href="<?= base_url(); ?>cotizaciones-aprobadas">
										<i class="las la-check-square"></i><span>Revisadas</span>
									</a>
								</li>
								<li class=" ">
									<a href="<?= base_url();?>cotizaciones-pendientes-revisar">
									<i class="las la-exclamation"></i><span>Pendientes</span>
									</a>
								</li>
							</ul>
						</li> -->
							...
							<ul class="navbar-nav ml-auto navbar-list align-items-center">
								...
								<li class="caption-content">
									<a href="#" class="iq-user-toggle">
										<img src="<?= base_url(); ?>assets/images/user/2.png" class="img-fluid rounded"
											alt="user">
									</a>
