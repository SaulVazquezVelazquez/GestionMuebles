					...
					<div class="card-body">
						<div class="form-row">
							<div class="col-md-6 mb-3">
								<p>Cotización: <?= $items[0]['folio_consecutivo'] ?></p>
								<p>Cliente: <?= $condiciones_comerciales[0]['card_foreign_name'] ?></p>
								<p>Factor de Cotización: <?= number_format($factor_cotizacion,0,".",",") ?> <button
						...
						<div class="form-row">
							<div class="col-md-12">
								...
								<button type="button" class="btn btn-outline-danger mt-2" data-toggle="modal"
									data-target="#formatoFormalCot">
									<i class="ri-file-pdf-2-line"></i>Formato Formal de Cotización</button>
								<button type="button" class="btn btn-outline-success mt-2" data-toggle="modal"
									data-target="#formatoWordCot"><i class="ri-file-pdf-2-line"></i>Formato Word</button>
								<button type="button" class="btn btn-outline-warning mt-2" data-toggle="modal"
								data-target="#formatoValidacionCot"><i class="ri-file-pdf-2-line"></i>Validacion</button>
								

								<?php if(empty($items[0]['auto_disenio'])):?>
									<button type="button" class="btn btn-outline-skyblue mt-2 disabled"><i class="ri-check-double-line"></i>No ha autorizado Direccion de Diseño</button>
								<?php elseif(empty($items[0]['auto_contabilidad'])): ?>
									<button type="button" class="btn btn-outline-skyblue mt-2 disabled"><i class="ri-check-double-line"></i>No ha autorizado Direccion de Contabilidad</button>
								<?php elseif(empty($items[0]['auto_ventas'])): ?>
									<button type="button" class="btn btn-outline-skyblue mt-2 disabled"><i class="ri-check-double-line"></i>No ha autorizado Direccion Comercial</button>
								<?php elseif(empty($items[0]['auto_direccion'])):?>
									<button type="button" class="btn btn-outline-skyblue mt-2" data-toggle="modal"
									data-target="#validarCot"><i class="ri-check-double-line"></i>Validar Cotización</button>
								<?php else: ?>
									<button type="button" class="btn btn-outline-skyblue mt-2 disabled" data-toggle="modal"
									data-target="#validarCot"><i class="ri-check-double-line"></i>Autorizada</button>
								<?php endif;?>
						...
						<tbody>
							...
							<tr>
								...
								<td >
									...
									<span class="float-right"><?= number_format($filteredItem['precio_costo'], 2, ".", ","); ?></span>
								</td>
								<td > 
									<span class="float-left">$</span> <!-- Símbolo de pesos alineado a la izquierda -->
									<span class="float-right"><?= number_format($filteredItem['quantity'] * $filteredItem['precio_costo'], 2, ".", ","); ?></span>
								</td>
							</tr>
							<?php endforeach;?>
							<tr>
								...
								<td>
									<span class="float-left"><b>$</b></span> <!-- Símbolo de pesos alineado a la izquierda -->
									<span class="float-right"><b><?= number_format($item['total_kit_hab'], 2, ".", ","); ?></b></span>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<span class="float-left">$</span> <!-- Símbolo de pesos alineado a la izquierda -->
									<span class="float-right"><?= number_format($datos['precio_costo'], 2, ".", ","); ?></span>
								</td>
								<td> 
									<span class="float-left">$</span> <!-- Símbolo de pesos alineado a la izquierda -->
									<span class="float-right"><?= number_format($datos['quantity'] * $datos['precio_costo'], 2, ".", ","); ?></span>
								</td>
							</tr>
							<?php endforeach;?>
							<tr>
								...
								<td>
									<span class="float-left"><b>$</b></span> <!-- Símbolo de pesos alineado a la izquierda -->
									<span class="float-right"><b><?= number_format($item['total_kit_hul'], 2, ".", ","); ?></b></span>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<span class="float-left"><b>$</b></span> <!-- Símbolo de pesos alineado a la izquierda -->
									<span class="float-right"><b><?= number_format($item['total_kit_mp'], 2, ".", ","); ?></b></span>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<span class="float-left"><b>$</b></span> <!-- Símbolo de pesos alineado a la izquierda -->
									<span class="float-right"><b><?= number_format($item['total_herraje_nacional'], 2, ".", ","); ?></b></span>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td > 
									<span class="float-left">$</span> <!-- Símbolo de pesos alineado a la izquierda -->
									<span class="float-right"><?= number_format($datos['piezas'] * $datos['precio_costo'], 2, ".", ","); ?></span>
								</td>
							</tr>
							<?php endforeach;?>
							<tr>
								...
								<td>
									<span class="float-left"><b>$</b></span> <!-- Símbolo de pesos alineado a la izquierda -->
									<span class="float-right"><b><?= number_format($item['total_g_patas'], 2, ".", ","); ?></b></span>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<span class="float-left"><b>$</b></span> <!-- Símbolo de pesos alineado a la izquierda -->
									<span class="float-right"><b><?= number_format($item['total_g_herrajes_importados'], 2, ".", ","); ?></b></span>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<span class="float-left"><b>$</b></span> <!-- Símbolo de pesos alineado a la izquierda -->
									<span class="float-right"><b><?= number_format($item['total_g_ebanesteria'], 2, ".", ","); ?></b></span>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<span class="float-left"><b>$</b></span> <!-- Símbolo de pesos alineado a la izquierda -->
									<span class="float-right"><b><?= number_format($item['total_g_telas'], 2, ".", ","); ?></b></span>
								</td>
							</tr>
						</tbody>
					</table>
				...
				<div class="form-row">
					<div class="col-md-12 mb-3 border-right">
						<div class="form-row">
							...
							<div class="col-md-6 mb-3 letra-small"> 
								<span class="float-left">$</span> <!-- Símbolo de pesos alineado a la izquierda -->
								<span class="float-right"><?= number_format($item['total_kit_hab']+$item['total_kit_hul']+$item['total_kit_mp'],2,".",","); ?></span>
							</div>
							<div class="col-md-6 mb-3 letra-small">
								Patas:
							</div>
							...
							<div class="col-md-6 mb-3 letra-small">
								<span class="float-left">$</span> <!-- Símbolo de pesos alineado a la izquierda -->
								<span class="float-right"><?= number_format($item['total_g_ebanesteria'],2,".",","); ?></span>
							</div>
							<div class="col-md-6 mb-3 letra-small">
								Herraje Violanti:
							</div>
							<div class="col-md-6 mb-3 letra-small">
								<span class="float-left">$</span> <!-- Símbolo de pesos alineado a la izquierda -->
								<span class="float-right"><?= number_format($item['total_herraje_nacional'],2,".",","); ?></span>
							</div>
							...
							<div class="col-md-6 mb-3 letra-small">
								<span class="float-left">$</span> <!-- Símbolo de pesos alineado a la izquierda -->
								<span class="float-right"><?= number_format($item['costo_materia_prima'],2,".",","); ?></span>
							</div>
							...
							<div class="col-md-6 mb-3 letra-small">
								<span class="float-left">$</span> <!-- Símbolo de pesos alineado a la izquierda -->
								<span class="float-right"><?= number_format($item['total_g_herrajes_importados'],2,".",","); ?></span>
							</div>
							<div class="col-md-6 mb-3 letra-small">
								Accesorios:
							</div>
...
<!-- FORMATO FORMAL DE COTIZACION -->
<div class="modal fade" id="formatoFormalCot" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
				¿ Está seguro de exportar a PDF la Cotización <b> No. : <?= $items[0]['folio_consecutivo'] ?></b> ?
			</div>
			<div class="modal-footer">
				<form action="<?= base_url(); ?>pdf-formato-formal-cotizacion" method="post" target="_blank">
					<input type="hidden" id="id_cotizacion_ffc" name="id_cotizacion_ffc" value="<?= $id_cotizacion; ?>">
					<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
					<button type="submit" class="btn btn-primary">Exportar</button>
				</form>
			</div>
...
<!-- FORMATO WORD -->
<div class="modal fade" id="formatoWordCot" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-footer">
			<form action="<?= base_url(); ?>pdf-formato-word" method="post" target="_blank">
					<input type="hidden" id="id_cotizacion_ffc" name="id_cotizacion_ffc" value="<?= $id_cotizacion; ?>">
					<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
					<button type="submit" class="btn btn-primary">Exportar</button>
				</form>
...
<!-- FORMATO DE VALIDACION COTIZACION -->
<div class="modal fade" id="formatoValidacionCot" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Detalle de factores</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			...
			<div class="modal-footer">
			<form action="<?= base_url(); ?>pdf-formato-validacion" method="post" target="_blank">
					<input type="hidden" id="id_cotizacion_ffc" name="id_cotizacion_ffc" value="<?= $id_cotizacion; ?>">
					<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
					<button type="submit" class="btn btn-primary">Exportar</button>
				</form>
...
<!-- VALIDAR COTIZACION -->
<div class="modal fade" id="validarCot" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Validar Cotizacón</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
			Validar cotización <b> No. : <?= $items[0]['folio_consecutivo'] ?></b> ( Se generará la Firma Electronica)
			</div>
			<div class="modal-footer">
				<form action="<?= base_url(); ?>autorizacion-cotizacion" method="post">
					<input type="hidden" name="id_cotizacion" value="<?= $items[0]['id_cotizacion'];?>">
					<input type="hidden" name="campo" value="auto_direccion">
