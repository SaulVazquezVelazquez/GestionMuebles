		...
		<div class="row">
				...
				<div class="card card-block p-card" style="height: 450px;">
					<div class="profile-box" style="height: 420px;">
						<div class="profile-card rounded">
							...
							<p class="text-white text-center mb-5">Precio Sugerido del jefe:
								$<?= number_format($item[0]['precio_sugerido'],2,".","."); ?></p>
						</div>
						<div class="pro-content rounded">
							<a  class="btn btn-block btn-outline-primary mt-2" href="<?= base_url();?>cotizaciones-aprobada-detalle/<?= $item[0]['id_cotizacion']; ?>/<?= $cliente['id_business_partnes']; ?>"><i class="ri-heart-line"></i>Regresar a la cotización</a>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="card-body">
						<div class="table-responsive">
							...
							<table class="table">
								...
								<tbody>
									<tr>
                                    <td>$<?= number_format($total_kits,2,".",","); ?></td>
                                    <td>$<?= number_format($total_patas,2,".",","); ?></td>
                                    <td>$<?= number_format($item[0]['mano_obra'],2,".",","); ?></td>
                                    <td>$<?= number_format($item[0]['mano_obra'],2,".",","); ?></td>
                                    <td>$<?= number_format($item[0]['mano_obra'],2,".",","); ?></td>
                                    <td>$<?= number_format($item[0]['mano_obra'],2,".",","); ?></td>
			...
			<div class="col-lg-12">
				...
				<div class="card card-block mb-3">
					<div class="card-header d-flex justify-content-between">
						<div class="iq-header-title">
							<h4 class="card-title mb-0">Contenido de Kit de Hule Espuma</h4>
						</div>
						<div class="iq-header-title">
							<h4 class="card-title mb-0">Total:
					...
					<div class="card-body">
						<div class="table-responsive">
							...
							<table class="table">
								...
								<tbody>
									<?php foreach ($kitHul as $itemkhab) : ?>
									<tr>
										<th scope="row"><?= $j++;?></th>
										<td><?= $itemkhab['codigo_sap_articulo']; ?></td>
										<td><?= $itemkhab['nombre_articulo']; ?></td>
			...
			<div class="col-lg-12">
                <!-- HERRAJE INCLUIDO EN LA MATERIA PRIMA -->
				<div class="card card-block mb-3">
					<div class="card-header d-flex justify-content-between">
						<div class="iq-header-title">
				...
				<div class="card card-block mb-3">
					<div class="card-header d-flex justify-content-between">
						...
						<div class="iq-header-title">
							<h4 class="card-title mb-0">Total:
								$<?= number_format($item[0]['total_g_patas'],2,".","."); ?></h4>
						</div>
					</div>
					<div class="card-body">
						<div class="table-responsive">
							...
							<table class="table">
								...
								<tbody>
									...
									<tr>
										<th scope="row"><?= $l++;?></th>
										<td><?= $itemPata['clave']; ?></td>
										<td><?= $itemPata['nombre']; ?></td>
										<td><?= $itemPata['piezas']; ?></td>
										<td>$<?= number_format($itemPata['precio_costo'],2,".",","); ?></td>
										<td>$<?= number_format($itemPata['piezas']*$itemPata['precio_costo'],2,".",","); ?>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
							...
							<table class="table">
								...
								<tbody>
									...
									<tr>
										...
										<td>$<?= number_format($itemHi['piezas']*$itemHi['precio_costo'],2,".",","); ?>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
							...
							<table class="table">
								...
								<tbody>
									...
									<tr>
										...
										<td>$<?= number_format($itemEb['piezas']*$itemEb['precio_costo'],2,".",","); ?>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
