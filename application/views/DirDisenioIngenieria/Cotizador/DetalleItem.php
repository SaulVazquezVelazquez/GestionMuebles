				...
				<div class="card card-block p-card" style="height: 450px;">
					<div class="profile-box" style="height: 420px;">
						...
						<div class="pro-content rounded">
							<a  class="btn btn-block btn-outline-primary mt-2" href="<?= base_url();?>detalle-cotizacion/<?= $id_cotizaciones_claves; ?>/<?= $id_cotizacion; ?>"><i class="ri-heart-line"></i>Regresar a la cotización</a>
						</div>
					</div>
				</div>
			</div>
