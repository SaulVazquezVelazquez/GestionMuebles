				...
				<form action="<?= base_url();?>previo-items-detalles" method="post">
					<div class="card">
						...
						<div id="mns_titulo" class="card-header d-flex justify-content-between">
							...
							<div class="header-title">
								<button id="procesar_orden" type="submit" class="btn btn-primary">Procesar
									Cotizacion</button>
							</div>
						</div>
								...
								<table class="table">
									...
									<tbody>
										<tr>
											...
											<input type="hidden" value="<?= $item['id_cotizaciones_claves']; ?>"
												name="id_cotizaciones_claves[]">
											<input type="hidden" value="<?= $item['id_cotizacion']; ?>"
												name="id_cotizacion">
											<input type="hidden" value="<?= $item['concepto']; ?>" name="concepto[]">
											<input type="hidden" value="<?= $item['mano_de_obra']; ?>"
												name="mano_de_obra[]">
											<input type="hidden" value="<?= $item['id_padre']; ?>" name="id_padre[]">
											<input type="hidden" value="<?= $item['imagen']; ?>" name="images[]">
											<input type="hidden" value="<?= $item['id_business_partnes']; ?>"
												name="id_business_partnes[]">
											<input type="hidden" value="<?= $item['card_foreign_name']; ?>"
												name="card_foreign_name[]">
