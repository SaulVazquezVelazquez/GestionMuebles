								...
								<tbody>
									<tr>
										...
										<td class="text-center letra-small bg-warning-light">
											$<?= number_format($item['total_mp'],2,".",",");?>
										</td>
										<td class="text-center letra-small">
											$<?= number_format($item['costo_materia_prima'],2,".",",");?>
										</td>
										<td class="text-center letra-small">
											$<?= number_format($item['costo_materia_prima'],2,".",",");?>
										</td>
										...
										<td class="text-center letra-small bg-danger-light">
											$<?= number_format($item['precio_sugerido'],2,".",",");?>
										</td>
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<form action="<?= base_url(); ?>autorizacion-cotizacion" method="post">
					<input type="hidden" name="id_cotizacion" value="<?= $items[0]['id_cotizacion'];?>">
					<input type="hidden" name="campo" value="auto_contabilidad">
