					...
					<div class="card-body">
						<div class="form-row">
							<div class="col-md-6 mb-3">
								...
								<p>Factor de Cotización: <?= number_format($factor_cotizacion,2,".",",") ?> <button
...
<div class="modal fade bd-example-modal-xl" id="detalle<?= $item["id_detalle_cotizacion"]; ?>" tabindex="-1"
	...
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="eliminar">Detalle de la clave - <?= $item["codigo_sap_articulo"]; ?></h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<div id="datosFiltrados<?= $item["id_detalle_cotizacion"]; ?>" style="display: none;">
	...
	<div class="col-sm-6">
		<div class="card">
			<div class="card-header d-flex justify-content-between">
				<div class="header-title">
					<h6 class="card-title">Responsable de la Clave: 
						
							<?php
							foreach ($datos_clave_cot as $codigo_sap => $info) {
								if ($codigo_sap === $item['codigo_sap_articulo']) {
									echo $info[0]['u_nom_usuario'] . "<br>";
								}
							}
							?> 
					</h6>
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<form action="<?= base_url(); ?>autorizacion-cotizacion" method="post">
					<input type="hidden" name="id_cotizacion" value="<?= $items[0]['id_cotizacion'];?>">
					<input type="hidden" name="campo" value="auto_ventas">
